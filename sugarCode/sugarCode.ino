 ...
 * Description: 
 * This code controls a stepper motor using the AccelStepper library. 
 * It allows the user to adjust the motor's angle using physical buttons 
 * and also includes a light sensor for additional interaction. 
 * The motor can be incremented or decremented by 1 degree 
